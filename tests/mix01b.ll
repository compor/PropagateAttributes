; RUN: opt -load %bindir/${TESTEE_PREFIX}%testee_name${TESTEE_SUFFIX} -propagate-attributes -ti-attr=noreturn -td-attr=attr1 -S < %s | FileCheck --check-prefix=CHECK-MERGED-ATTR %s
